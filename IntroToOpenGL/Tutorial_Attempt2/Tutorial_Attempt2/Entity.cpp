...
//Private Functions
GLuint Entity::CreateShader(GLenum a_eShaderType, const char *a_strShaderFile)
{
...
GLuint Entity::CreateProgram(const char *a_vertex, const char *a_frag)
{
...
float* Entity::getOrtho(float left, float right, float bottom, float top, float a_fNear, float a_fFar)
{
